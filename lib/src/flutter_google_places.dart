...
class PlacesAutocompleteWidget extends StatefulWidget {
  ...
  final Function(Prediction) onPressed;
...
class _PlacesAutocompleteOverlayState extends PlacesAutocompleteState {
  ...
  Widget _textField(BuildContext context) => Padding(
        child: TextField(
...
class PlacesAutocomplete {
  static Future<Prediction> show(
      ...
      @required Function(Prediction) onPressed,
      @required Function(dynamic) onDialogDismissed,
